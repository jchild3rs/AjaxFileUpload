  ...
  AjaxFileUpload = (function() {
    ...
    AjaxFileUpload.prototype.handleAjaxStateChange = function(event) {
      ...
      if (this.xhr.status === 200 || this.xhr.status === 201) {
        this.settings.onSuccess.apply(this, [data, this.input.files, this.xhr]);
      } else {
        this.settings.onError.apply(this, [data, this.input.files, this.xhr]);
      }
    };

    AjaxFileUpload.prototype.handleAjaxProgressLoad = function(event) {
      return this.settings.onProgressEnd.apply(this, [event, this.input.files, this.xhr]);
    };

    AjaxFileUpload.prototype.handleAjaxProgress = function(event) {
      return this.settings.onProgress.apply(this, [event, this.input.files, this.xhr]);
    };

    AjaxFileUpload.prototype.handleAjaxProgressStart = function(event) {
      return this.settings.onProgressStart.apply(this, [event, this.input.files, this.xhr]);
    };
